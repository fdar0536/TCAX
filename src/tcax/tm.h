 ...
 */
extern void libtm_fill_tm_word_hori(const SYL_pWord pWord, const TM_pTextHori pTextHori, TM_pWordHori pWordHori);
 ...
 */
extern void libtm_fill_tm_word_vert(const SYL_pWord pWord, const TM_pTextVert pTextVert, TM_pWordVert pWordVert);
 ...
 */
extern void libtm_fill_tm_adv_hori(const SYL_pAdv pAdv, const TM_pTextHori pTextHori, TM_pAdvHori pAdvHori);
 ...
 */
extern void libtm_fill_tm_adv_vert(const SYL_pAdv pAdv, const TM_pTextVert pTextVert, TM_pAdvVert pAdvVert);
