...
#else
PY_Error_Code tcaxpy_create_py_token() {
    return py_error_file_cant_create;
}

PY_Error_Code tcaxpy_synchronize_py_token() {
    return py_error_file_cant_create;
}
PY_Error_Code tcaxpy_is_py_modified() {
    return py_error_file_modified;
}
#endif  /* WIN32 */
...
#else
static PY_Error_Code _tcaxpy_write_unicode_to_utf8_file(const char *filename, const wchar_t *uni) {
#endif
    FILE *fp;
    int size;
    char *utf8String;
